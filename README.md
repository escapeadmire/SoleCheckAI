...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/solecheckai
```

A live public deployment of this template is available at [https://solecheckai.templates.workers.dev](https://solecheckai.templates.workers.dev)
